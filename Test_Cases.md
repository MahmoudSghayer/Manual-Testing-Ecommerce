...
| TC_R5_03 | TS_R5_03 | Verify product removal from cart | Product exists in cart | 1. Open cart page<br>2. Click remove/delete product | Cart empty | Product removed and cart updated correctly | | | Medium |
